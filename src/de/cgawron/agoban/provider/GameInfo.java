...
/**
 * This class contains meta information on a game, i.e. players, results, event, rules etc.
 * The information is hashed in a database and only updated as needed.
 *
...
public class GameInfo 
{
    ...
    final public static @Column @SGFProperty String KEY_WHITE_RANK = "WR";
    final public static @Column @SGFProperty String KEY_BLACK_RANK = "BR";

    private static Key[] sgfKeys;
    //private static String[] displayColumns = { KEY_ID, KEY_MODIFIED_DATE, KEY_PLAYER_WHITE, KEY_PLAYER_BLACK };
    private static String[] displayColumns = { KEY_ID, KEY_FILENAME, KEY_MODIFIED_DATE };
    private File file;
    private ContentValues values;

    /**
     * Create GameInfo from file.
     * @todo This should be optimized - it's not necessary to create the whole GameTree structure to build the GameInfo. 
     */
