...
public interface MarkupModel extends Goban {
	...
	public static class ConflictMark extends Stone {
		...
		public boolean equals(Object o) {
			if (o == this)
				...
				return getColor() == ((ConflictMark) o).getColor()
						&& text.equals(((ConflictMark) o).text);
			} else
				return false;
		}
	}
	...
	/**
	 * Arbitrary text to be rendered on the Goban. For the display of move
	 * numbers, {@link de.cgawron.go.goban.MarkupModel.Move} should be used.
	 * 
