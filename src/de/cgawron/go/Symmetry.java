...
{
    /**
     * The symmetry is stored as follows:
     * bit 0: exchange x and y
     * bit 1: reflection (x-axis)
     * bit 2: reflection (y-axis)
     * bit 3: color exchange
     */
    ...
    /*
    private static Symmetry cache[] = new Symmetry[16];
    static {
	int i;
	for (i=0; i<16; i++)
	    cache[i] = new Symmetry(i);
    }
    */
