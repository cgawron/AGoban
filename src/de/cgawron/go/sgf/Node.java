...
{
    private final PropertyList inheritedProperties = new PropertyList();
    ...
    {
	logger.fine("Node.addPropertyChangeListener: " + listener + ", " + propertyName);
    ...
    {
	logger.fine("Node.removePropertyChangeListener: " + listener + ", " + propertyName);
	...
	*/
	...
	if (!contains(key))
		...
		logger.severe("Value already set! old: " + oldValue + " new: " + newValue);
	}
    }
