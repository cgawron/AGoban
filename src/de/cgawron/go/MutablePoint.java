...
/**
 * A point on a Goban.
 * This class adds methods to set the x and y components to the immutable class Point.
...
public class MutablePoint extends Point
{
    ...
    /**
     * MutablePoint constructor comment.
     * @param p - Point from which to initialize the coordinates.
     */
     ...
     * @param p - a Point from which the coordinates are copied
     * @return the modified MutablePoint
     */
