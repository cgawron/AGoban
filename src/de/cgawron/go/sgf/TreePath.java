 ...
 * root is always the first element (index 0) of the array. TreePath is
 * Serializable, but if any components of the path are not serializable, it will
 * not be written out.
 * <p>
...
public class TreePath extends Object implements Serializable {
	...
	/**
	 * Returns true if <code>aTreePath</code> is a descendant of this TreePath.
	 * A TreePath P1 is a descendant of a TreePath P2 if P1 contains all of the
	 * components that make up P2's path. For example, if this object has the
	 * path [a, b], and <code>aTreePath</code> has the path [a, b, c], then
	 * <code>aTreePath</code> is a descendant of this object. However, if
	 ...
	 * newly created TreePath. This will throw a NullPointerException if child
	 * is null.
	 */
